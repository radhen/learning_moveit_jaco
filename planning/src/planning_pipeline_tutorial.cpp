...
int main(int argc, char **argv)
{
  ...
  req.group_name = "Arm";
  moveit_msgs::Constraints pose_goal = kinematic_constraints::constructGoalConstraints("jaco_6_hand_limb", pose, tolerance_pose, tolerance_angle);
  ...
  const robot_model::JointModel* joint_model = joint_model_group->getJointModel("jaco_arm_4_joint");
